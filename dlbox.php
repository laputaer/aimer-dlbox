...
function dlbox($atts, $content = null)
{
    ...
    $out = '<p hidden>本下载框使用A酱的插件:aimer-dlbox生成<br />了解更多信息请访问 https://ht.acgbuster.com</p><span style="font-size: 12pt;"><div class="aimerdown" id="aimerdown"><p hidden>本下载框使用A酱的插件:aimer-dlbox生成<br />了解更多信息请访问 https://ht.acgbuster.com</p><div class="down-title"><br>下<br>载<br>面<br>板</div><div class="down-detail"><p class="down-price"><i class="fa fa-calendar" aria-hidden="true"></i>
来源：<span>' . $b . '</span><p hidden>本下载框使用A酱的插件:aimer-dlbox生成<br />了解更多信息请访问 https://ht.acgbuster.com</p><a style="color: #FF0000;"> 【文件大小：' . $f . '】</a></p><p class="down-ordinary"><i class="fa fa-clock-o" aria-hidden="true"></i>
更新日期：' . $c . '</p>
...
磁力：' . $e . '<p hidden>本下载框使用A酱的插件:aimer-dlbox生成<br />了解更多信息请访问 https://ht.acgbuster.com</p></p><p><p class="down-tip"><i class="fa fa-connectdevelop" aria-hidden="true"></i>
